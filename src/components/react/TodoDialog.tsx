...
export const TodoDialog: FC<TodoDialogProps> = ({ todo, onClose, dialogRef }) => {
    ...
    const numberOfTimesMarkedAsToBeDoneToday = titleCase(converter.toWordsOrdinal(todo.numberOfTimesMarkedAsToBeDoneToday));
        ...
        <dialog
            ...
            <div className="flex flex-col px-8 py-4 gap-y-8">
                <div className="flex flex-col gap-y-2 border-b max-w-md">
                    ...
                    {
                        todo.numberOfTimesMarkedAsToBeDoneToday > 0 && filterType === "today" &&
                    ...
                    <div className="flex space-x-4 py-2">
                        <MarkAsDoneButton name="MarkAsDoneButton" todoId={todo.id} onClose={onClose} />
                    ...
                    (!showDescriptionEditor && todo.description) ? (
                        <>
                            <div className="flex flex-col gap-y-2">
                                <label htmlFor="todoDescription" className="flex flex-col text-sm text-gray-700">
                                    Notes
                                </label>
